		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SOX Segregation of Duties Report",
									"targetURL": "#comewmyy1soxui5yy1soxui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comewmyy1soxui5yy1soxui5-display": {
								"semanticObject": "comewmyy1soxui5yy1soxui5",
								"action": "display",
								"description": "SOX Segregation of Duties Report",
								"title": "SOX Segregation of Duties Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ewm.yy1soxui5.yy1soxui5",
									"url": sap.ui.require.toUrl("com/ewm/yy1soxui5/yy1soxui5")
								}
							}
						}
					}
